...
w_lable = Label(root, text="Welcome to Email Sender", background="#1A3D56", foreground="light yellow")
w_lable.place(relx=0.5, rely=0.05, anchor=CENTER)

s_lable = Label(root, text="Your Email:", background="#1A3D56", foreground="light yellow")
...
r_lable = Label(root, text="Reciver Email:", background="#1A3D56", foreground="light yellow")
...
sub_lable = Label(root, text="Email Subject:", background="#1A3D56", foreground="light yellow")
...
t_lable = Label(root, text="Body:", background="#1A3D56", foreground="light yellow")
